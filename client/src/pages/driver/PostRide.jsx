...
const PostRide = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!form.sourceLat || !form.destinationLat) {
      setMsg("Please select source and destination from the suggestions.");
      return;
    }
      ...
      <div className="max-w-2xl mx-auto px-6 py-10">
        <div className="animate-fade-up mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Fill in the details below to offer seats on your trip
          </p>
        </div>

        {msg && (
          <div
            className="mb-6 p-3 text-sm font-bold animate-fade-up"
            style={{ background: "#ff6b6b", border: "2px solid #1a1a1a", boxShadow: "3px 3px 0 #1a1a1a" }}
          >
            {msg}
          </div>
        )}
